...
// MySQLErrName maps error code to MySQL error message templates.
var MySQLErrName = map[uint16]string{
	...
	ErrTooLongKey:                               "Specified key was too long (%d bytes); max key length is %d bytes",
	...
	ErrJSONVacuousPath:                          "The path expression '$' is not allowed in this context.",
	ErrJSONBadOneOrAllArg:                       "The oneOrAll argument to %s may take these values: 'one' or 'all'.",
	...
	ErrNetPacketTooLarge:                        "Got a packet bigger than 'max_allowed_packet' bytes",
	...
	ErrTooBigPrecision:                          "Too-big precision %d specified for '%-.192s'. Maximum is %d.",
	...
	ErrDropIndexNeededInForeignKey:              "Cannot drop index '%-.192s': needed in a foreign key constraint",
	...
	ErrWarnDeprecatedSyntaxNoReplacement:                     "%s is deprecated and will be removed in a future release.%s",
	...
	ErrSetPasswordAuthPlugin:                                 "SET PASSWORD has no significance for user '%-.48s'@'%-.255s' as authentication plugin does not support it.",
	ErrGrantPluginUserExists:                                 "GRANT with IDENTIFIED WITH is illegal because the user %-.*s already exists",
	ErrTruncateIllegalForeignKey:                             "Cannot truncate a table referenced in a foreign key constraint (%.192s)",
	...
	ErrNotValidPassword:                                      "Your password does not satisfy the current policy requirements (%s)",
	...
	ErrForeignKeyNoIndexInParent:                             "Failed to add the foreign key constraint. Missing index for constraint '%s' in the referenced table '%s'",
	ErrFkFailAddSystem:                                       "Failed to add the foreign key constraint '%s' to system tables",
	ErrForeignKeyCannotOpenParent:                            "Failed to open the referenced table '%s'",
	...
	ErrForeignKeyColumnNotNull:                               "Column '%-.192s' cannot be NOT NULL: needed in a foreign key constraint '%-.192s' SET NULL",
	...
	ErrForeignKeyColumnCannotChange:                          "Cannot change column '%-.192s': used in a foreign key constraint '%-.192s'",
	ErrForeignKeyColumnCannotChangeChild:                     "Cannot change column '%-.192s': used in a foreign key constraint '%-.192s' of table '%-.192s'",
	...
	ErrPasswordExpireAnonymousUser:                           "The password for anonymous user cannot be expired.",
	...
	ErrInvalidJSONTextInParam:                                "Invalid JSON text in argument %d to function %s: \"%s\" at position %d.",
	ErrInvalidJSONPath:                                       "Invalid JSON path expression %s.",
	ErrInvalidJSONCharset:                                    "Cannot create a JSON value from a string with CHARACTER SET '%s'.",
	ErrInvalidTypeForJSON:                                    "Invalid data type for JSON data in argument %d to function %s; a JSON string or JSON type is required.",
	ErrInvalidJSONPathWildcard:                               "In this situation, path expressions may not contain the * and ** tokens or an array range.",
	...
	ErrJSONDocumentTooDeep:                                   "The JSON document exceeds the maximum depth.",
	...
	ErrRoleNotGranted:                                        "%s is not granted to %s",
	ErrMaxExecTimeExceeded:                                   "Query execution was interrupted, maximum statement execution time exceeded",
	...
	ErrFKIncompatibleColumns:                                 "Referencing column '%s' and referenced column '%s' in foreign key constraint '%s' are incompatible.",
	...
	ErrWarnOptimizerHintWrongPos:        "Optimizer hint can only be followed by certain keywords like SELECT, INSERT, etc.",
}
