...
const (
	...
	// meant for canonicalization paths — normalizing CHECK-constraint and
	// generated-column expressions, for instance. Default SQL restore keeps
	// user-written parentheses so a statement round-trips as written.
