...
func TestLintingBasicInfrastructure(t *testing.T) {
	...
	m := NewTestMigration(t, WithTable("t1lint"), WithAlter("ENGINE=InnoDB"), WithThreads(1), WithLint())
...
func TestLintInvisibleIndexBeforeDrop_Warning(t *testing.T) {
	...
	m := NewTestMigration(t, WithTable("t1idx"), WithAlter("DROP INDEX idx_name"), WithThreads(1), WithLint())
	require.NoError(t, m.Run())
}
...
func TestLintInvisibleIndexBeforeDrop_AlreadyInvisible(t *testing.T) {
	...
	m := NewTestMigration(t, WithTable("t1idxinv"), WithAlter("DROP INDEX idx_name"), WithThreads(1), WithLint())
	require.NoError(t, m.Run())
}
...
func TestLintPrimaryKeyType_IntWarning(t *testing.T) {
	...
	m := NewTestMigration(t, WithTable("t1pkint"), WithAlter("ENGINE=InnoDB"), WithThreads(1), WithLint())
	require.NoError(t, m.Run())
}
...
func TestLintPrimaryKeyType_SignedBigintWarning(t *testing.T) {
	...
	m := NewTestMigration(t, WithTable("t1pkbigint"), WithAlter("ENGINE=InnoDB"), WithThreads(1), WithLint())
	require.NoError(t, m.Run())
}
...
func TestLintPrimaryKeyType_UnsignedBigintOK(t *testing.T) {
	...
	m := NewTestMigration(t, WithTable("t1pkubigint"), WithAlter("ENGINE=InnoDB"), WithThreads(1), WithLint())
	require.NoError(t, m.Run())
}
...
func TestLintPrimaryKeyType_BinaryOK(t *testing.T) {
	...
	m := NewTestMigration(t, WithTable("t1pkbin"), WithAlter("ENGINE=InnoDB"), WithThreads(1), WithLint())
	require.NoError(t, m.Run())
}
...
func TestLintMultipleAlterTable(t *testing.T) {
	...
	m := NewTestMigration(t, WithThreads(1), WithLint(),
...
func TestLintGetCreateTable(t *testing.T) {
	...
	m := NewTestMigration(t, WithTable("t1getcreate"), WithAlter("ADD COLUMN age INT"), WithThreads(1), WithLint())
	require.NoError(t, m.Run())
}
...
func TestLintCreateTableWithLinting(t *testing.T) {
	...
	m = NewTestMigration(t, WithTable("t1createalter"), WithAlter("ADD COLUMN email VARCHAR(255)"), WithThreads(1), WithLint())
	require.NoError(t, m.Run())
...
func TestLintNoViolations(t *testing.T) {
	...
	m := NewTestMigration(t, WithTable("t1clean"), WithAlter("ADD COLUMN email VARCHAR(255)"), WithThreads(1), WithLint())
	require.NoError(t, m.Run())
}
...
func TestLintWithoutEnablingLinting(t *testing.T) {
	...
	m := NewTestMigration(t, WithThreads(1),
		WithStatement(`CREATE TABLE t1nolint (id INT NOT NULL PRIMARY KEY, name VARCHAR(255))`))
	require.NoError(t, m.Run())
...
func TestLintOnly(t *testing.T) {
	...
	m := NewTestMigration(t, WithTable("t1lintonly"), WithAlter("DROP INDEX c2"), WithThreads(1), WithLintOnly())
	require.NoError(t, m.Run())
	...
	m = NewTestMigration(t, WithTable("t1lintonly2"), WithAlter("ADD COLUMN email VARCHAR(255)"), WithThreads(1), WithLintOnly())
	require.NoError(t, m.Run())
...
func TestLintOnlyImpliesLint(t *testing.T) {
	...
	m := NewTestMigration(t, WithThreads(1), WithLintOnly(),
