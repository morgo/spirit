...
|--------|---------|---------------|
| **`spirit`** | Online schema change tool — applies `ALTER TABLE` statements to large tables without blocking reads or writes | [USAGE.md](USAGE.md) |
